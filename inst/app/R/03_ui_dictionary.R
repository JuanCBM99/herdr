          ...
          div(
            ...
            div(
              ...
              tags$dl(
                ...
                tags$dt(class = "col-sm-3 text-monospace", tags$code("eggs_per_year")),
                tags$dd(class = "col-sm-9", "Annual egg production per laying hen (eggs/hen/year, e.g. 310–325 for layers, 210–220 for meat breeders)."),
