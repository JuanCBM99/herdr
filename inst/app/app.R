...
read_clean <- function(path) {
  ...
  readr::read_csv(path, show_col_types = FALSE, lazy = FALSE, progress = FALSE) %>%
...
# ==============================================================================
# 3. HANDSONTABLE & JAVASCRIPT EXTENSIONS
# ==============================================================================
        ...
        div(
          ...
          div(
            ...
            div(
              ...
              tags$dl(
                class = "row",
                tags$dt(class = "col-sm-4", "animal_tag"),
                tags$dd(class = "col-sm-8", "Mandatory: A unique name for this specific group of animals (e.g., 'mature_dairy_cattle')."),
                tags$dt(class = "col-sm-4", "animal_type"),
                tags$dd(class = "col-sm-8", "Broad species category (e.g., 'cattle', 'sheep', 'swine')."),
                tags$dt(class = "col-sm-4", "animal_subtype"),
                tags$dd(class = "col-sm-8", "Specific production type (e.g., 'dairy', 'beef')."),
                tags$dt(class = "col-sm-4", "region"),
                tags$dd(class = "col-sm-8", "Optional: A general location or grouping level (e.g., 'Europe', 'Spain', or 'Farm A')."),
                tags$dt(class = "col-sm-4", "subregion"),
                tags$dd(class = "col-sm-8", "Optional: A subdivision of your Region (e.g., if Region is 'Spain', Subregion could be 'Euskadi')."),
                tags$dt(class = "col-sm-4", "class_flex"),
                tags$dd(class = "col-sm-8", "Optional: A flexible tag to group animals by trait, breed, or phase (e.g., 'lactating', 'dry', 'angus')."),
                tags$dt(class = "col-sm-4", "population"),
                tags$dd(class = "col-sm-8", "Total number of animals in this exact combination of animal_tag, region, subregion and class_flex.")
              ),
              hr(class = "my-4"),

              # --- SECTION 2: Weights & Productive Period ---
              h5(icon("scale-balanced"), "Animal Weights & Productive Period", class = "mb-3 text-primary"),
              tags$dl(
                class = "row",
                tags$dt(class = "col-sm-4", "initial_weight_kg"),
                tags$dd(class = "col-sm-8", "Starting weight of the animal at the beginning of the evaluated period (in kg)."),
                tags$dt(class = "col-sm-4", "final_weight_kg"),
                tags$dd(class = "col-sm-8", "Target ending weight of the animal at the end of the period (in kg)."),
                tags$dt(class = "col-sm-4", "adult_weight_kg"),
                tags$dd(class = "col-sm-8", "Average weight of a fully grown mature animal (in kg)."),
                tags$dt(class = "col-sm-4", "productive_period_days"),
                tags$dd(class = "col-sm-8", "Number of days the animal is in its active production phase (e.g., fattening days, lactation days).")
              ),
              hr(class = "my-4"),

              # --- SECTION 3: Diet & Feed Characteristics ---
              h5(icon("wheat-awn"), "Diet & Feed Characteristics", class = "mb-3 text-warning"),
              tags$dl(
                class = "row",
                tags$dt(class = "col-sm-4", "diet_tag"),
                tags$dd(class = "col-sm-8", "The name of the diet. This links the animal group to the food they eat."),
                tags$dt(class = "col-sm-4", "ingredient"),
                tags$dd(class = "col-sm-8", "The specific food item (e.g., 'Corn silage', 'Soybean meal')."),
                tags$dt(class = "col-sm-4", "ingredient_type"),
                tags$dd(class = "col-sm-8", "Category of the ingredient. Must be: 'forage', 'concentrate', 'milk', or 'milk_replacer'."),
                tags$dt(class = "col-sm-4", "forage_share"),
                tags$dd(class = "col-sm-8", "Percentage of the diet made up of roughage/forage (e.g., pasture, hay, silage)."),
                tags$dt(class = "col-sm-4", "concentrate_share"),
                tags$dd(class = "col-sm-8", "Percentage of the diet made up of concentrates (e.g., grains, pellets, soy)."),
                tags$dt(class = "col-sm-4", "milk_share"),
                tags$dd(class = "col-sm-8", "Percentage of the diet consisting of natural maternal milk (for young animals)."),
                tags$dt(class = "col-sm-4", "milk_replacer_share"),
                tags$dd(class = "col-sm-8", "Percentage of the diet consisting of artificial milk formula/replacer."),
                tags$dt(class = "col-sm-4", "ingredient_share"),
                tags$dd(class = "col-sm-8", "Percentage of this specific ingredient within the ingredient_type."),
                tags$dt(class = "col-sm-4", "DM_pct"),
                tags$dd(class = "col-sm-8", "Dry Matter (%): The portion of the feed that remains after all water is removed."),
                tags$dt(class = "col-sm-4", "CP_pct"),
                tags$dd(class = "col-sm-8", "Crude Protein (%): Protein content, essential for muscle growth and milk production."),
                tags$dt(class = "col-sm-4", "NDF_pct"),
                tags$dd(class = "col-sm-8", "Neutral Detergent Fiber (%): Total structural fiber that gives bulk to the diet."),
                tags$dt(class = "col-sm-4", "ASH_pct"),
                tags$dd(class = "col-sm-8", "Ash (%): The total inorganic mineral content left in the feed."),
                tags$dt(class = "col-sm-4", "EE_pct"),
                tags$dd(class = "col-sm-8", "Ether Extract (%): The crude fat content of the feed."),
                tags$dt(class = "col-sm-4", "DE_pct"),
                tags$dd(class = "col-sm-8", "Digestibility of the feed (%)"),
                tags$dt(class = "col-sm-4", "GE_feed_kcal_kg"),
                tags$dd(class = "col-sm-8", "Gross Energy: The total energy contained in the feed (in kcal per kg)."),
                tags$dt(class = "col-sm-4", "country_of_origin"),
                tags$dd(class = "col-sm-8", "Optional: Where this feed was grown. Leave blank to use your farm's country."),
                tags$dt(class = "col-sm-4", "custom_yield_kg_ha"),
                tags$dd(class = "col-sm-8", "Optional: Crop yield. Leave blank if you don't know it (we'll use standard FAO data)."),
                tags$dt(class = "col-sm-4", "yield_name"),
                tags$dd(class = "col-sm-8", "FAOSTAT name of the ingredient used to link its database with herdr"),
                tags$dt(class = "col-sm-4", "agribalyse_name"),
                tags$dd(class = "col-sm-8", "Agribalyse name of the ingredient used to link its database with herdr")
              ),
              hr(class = "my-4"),

              # --- SECTION 4: Ruminant Production & IPCC Coefficients ---
              h5(icon("clipboard-list"), "Ruminant Production & IPCC Coefficients", class = "mb-3 text-info"),
              tags$dl(
                class = "row",
                tags$dt(class = "col-sm-4", "cfi"),
                tags$dd(class = "col-sm-8", "IPCC coefficient for maintenance. Select the description that fits your animal."),
                tags$dt(class = "col-sm-4", "cfi_maintenance"),
                tags$dd(class = "col-sm-8", "Maintenance coefficient in kcal/kg_day"),
                tags$dt(class = "col-sm-4", "ca"),
                tags$dd(class = "col-sm-8", "IPCC coefficient for feeding situation. Select how active the animals are (e.g., confined vs. grazing)."),
                tags$dt(class = "col-sm-4", "c"),
                tags$dd(class = "col-sm-8", "Only for Cattle: IPCC constant 'C' used to calculate energy for growth."),
                tags$dt(class = "col-sm-4", "a"),
                tags$dd(class = "col-sm-8", "Only for Sheep: IPCC constant 'a' used to calculate energy for growth."),
                tags$dt(class = "col-sm-4", "b"),
                tags$dd(class = "col-sm-8", "Only for Sheep: IPCC constant 'b' used to calculate energy for growth."),
                tags$dt(class = "col-sm-4", "c_pregnancy"),
                tags$dd(class = "col-sm-8", "IPCC coefficient used to calculate the extra energy needed during pregnancy."),
                tags$dt(class = "col-sm-4", "c_pregnancy_cattle"),
                tags$dd(class = "col-sm-8", "Pregnancy coefficient specific to cattle. Populate this parameter only for breeding groups."),
                tags$dt(class = "col-sm-4", "pregnancy_rate"),
                tags$dd(class = "col-sm-8", "Pregnancy rate expressed as a proportion (numeric value bounded between 0 and 1)."),
                tags$dt(class = "col-sm-4", "pr"),
                tags$dd(class = "col-sm-8", "Prolificacy Rate: The average number of lambs born per pregnant ewe."),
                tags$dt(class = "col-sm-4", "pr_sheep_goat"),
                tags$dd(class = "col-sm-8", "Prolificacy rate for sheep and goats, representing the number of lambs/kids born in a year divided by the number of pregnant ewes in a year."),
                tags$dt(class = "col-sm-4", "milk_yield_kg_year"),
                tags$dd(class = "col-sm-8", "Total milk produced by one average animal in a full year (in kg)."),
                tags$dt(class = "col-sm-4", "fat_content_pct"),
                tags$dd(class = "col-sm-8", "Percentage of fat in the milk (e.g., type 4.0 for 4%)."),
                tags$dt(class = "col-sm-4", "wool_yield_kg_year"),
                tags$dd(class = "col-sm-8", "Total wool produced by one animal in a year (in kg)."),
                tags$dt(class = "col-sm-4", "work_hours"),
                tags$dd(class = "col-sm-8", "Number of hours per day the animal is used for physical draft/work.")
              ),
              hr(class = "my-4"),

              # --- SECTION 5: Monogastrics (Swine & Poultry) ---
              h5(icon("drumstick-bite"), "Monogastrics (Swine & Poultry)", class = "mb-3", style = "color: #d97706;"),
              tags$dl(
                class = "row",
                tags$dt(class = "col-sm-4", "swine_DE_kcal_kg"),
                tags$dd(class = "col-sm-8", "Digestible Energy specific for pigs (in kcal per kg)."),
                tags$dt(class = "col-sm-4", "swine_ME_kcal_kg"),
                tags$dd(class = "col-sm-8", "Metabolizable Energy specific for pigs (in kcal per kg)."),
                tags$dt(class = "col-sm-4", "poultry_ME_kcal_kg"),
                tags$dd(class = "col-sm-8", "Metabolizable Energy specific for poultry (in kcal per kg)."),
                tags$dt(class = "col-sm-4", "alpha"),
                tags$dd(class = "col-sm-8", "Metabolic weight coefficient"),
                tags$dt(class = "col-sm-4", "frac_fat_pct"),
                tags$dd(class = "col-sm-8", "Fat fraction in the animal's daily weight gain."),
                tags$dt(class = "col-sm-4", "frac_protein_pct"),
                tags$dd(class = "col-sm-8", "Protein fraction in the animal's daily weight gain."),
                tags$dt(class = "col-sm-4", "sows_gestation_days"),
                tags$dd(class = "col-sm-8", "Number of days a sow is pregnant."),
                tags$dt(class = "col-sm-4", "sows_lactation_days"),
                tags$dd(class = "col-sm-8", "Number of days a sow nurses her piglets before weaning."),
                tags$dt(class = "col-sm-4", "piglets_born"),
                tags$dd(class = "col-sm-8", "Average number of piglets born in a single litter (only for breeding sows)."),
                tags$dt(class = "col-sm-4", "piglets_suckling"),
                tags$dd(class = "col-sm-8", "Average number of piglets actively nursing from the mother (only for lactating sows)."),
                tags$dt(class = "col-sm-4", "piglet_birth_weight_kg"),
                tags$dd(class = "col-sm-8", "Average weight of a single piglet exactly when it is born (in kg)."),
                tags$dt(class = "col-sm-4", "piglet_weaning_weight_kg"),
                tags$dd(class = "col-sm-8", "Average weight of a single piglet when it is separated from the mother (in kg)."),
              ...
              # --- SECTION 6: Manure Management & LCA ---
              h5(icon("recycle"), "Manure Management & LCA", class = "mb-3 text-danger"),
              tags$dl(
                class = "row",
                tags$dt(class = "col-sm-4", "system_base"),
                tags$dd(class = "col-sm-8", "The main way manure is stored or managed (e.g., 'Liquid/Slurry', 'Pasture')."),
                tags$dt(class = "col-sm-4", "system_variant"),
                tags$dd(class = "col-sm-8", "A specific variation of the manure system (if applicable)."),
                tags$dt(class = "col-sm-4", "management_months"),
                tags$dd(class = "col-sm-8", "How many months per year the animals use this specific manure system."),
                tags$dt(class = "col-sm-4", "climate_zone"),
                tags$dd(class = "col-sm-8", "The general climate of your farm (e.g., 'Temperate', 'Warm')."),
                tags$dt(class = "col-sm-4", "climate_moisture"),
                tags$dd(class = "col-sm-8", "Moisture level of your region's climate (e.g., 'Dry' or 'Wet')."),
                tags$dt(class = "col-sm-4", "system_climate"),
                tags$dd(class = "col-sm-8", "Specific temperature or condition for this manure system, if required by the main system."),
                tags$dt(class = "col-sm-4", "system_subclimate"),
                tags$dd(class = "col-sm-8", "Specific temperature or condition for this manure system, if required by the main system."),
                tags$dt(class = "col-sm-4", "allocation"),
                tags$dd(class = "col-sm-8", "Fraction of the total manure managed in this specific system (between 0 and 1). All systems for an animal must sum to 1."),
                tags$dt(class = "col-sm-4", "b_0"),
                tags$dd(class = "col-sm-8", "Maximum methane-producing capacity (B0). Select the description that matches your animal type."),
                tags$dt(class = "col-sm-4", "MCF_pct"),
                tags$dd(class = "col-sm-8", "Methane Conversion Factor (%): The percentage of manure that actually turns into methane gas in this system."),
                tags$dt(class = "col-sm-4", "EF3"),
                tags$dd(class = "col-sm-8", "Emission Factor 3: Rate used to calculate direct nitrous oxide (N2O) emissions from the manure."),
                tags$dt(class = "col-sm-4", "EF4"),
                tags$dd(class = "col-sm-8", "Emission Factor 4: Rate used to calculate indirect N2O emissions from gases escaping into the air (volatilization)."),
                tags$dt(class = "col-sm-4", "EF5"),
                tags$dd(class = "col-sm-8", "Emission Factor 5: Rate used to calculate indirect N2O emissions from manure washing into soil and water (leaching)."),
                tags$dt(class = "col-sm-4", "frac_gas"),
                tags$dd(class = "col-sm-8", "Fraction of nitrogen excreted that is volatilized"),
                tags$dt(class = "col-sm-4", "frac_leach"),
                tags$dd(class = "col-sm-8", "Fraction of nitrogen lost through leaching/runoff."),
                tags$dt(class = "col-sm-4", "economic_allocation"),
                tags$dd(class = "col-sm-8", "Used to allocate environmental impacts between a main product and its co-products (e.g., milk and meat) based on their relative economic value.")
              )
            )
          )
        )
