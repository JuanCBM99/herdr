...
#' @export
calculate_N2O_indirect_volatilization <- function(automatic_cycle = FALSE, saveoutput = TRUE, data_dir = "user_data") {

  message("\U0001f7e2 Calculating indirect N2O emissions (volatilization)...")
