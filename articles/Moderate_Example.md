...
`c_pregnancy_cattle` is a separate lookup into `ipcc_coefficients.csv`.
...
| animal_tag | region | subregion | adult_weight_kg | productive_period_days | initial_weight_kg | final_weight_kg |
|:---|:---|:---|---:|---:|---:|---:|
...
| animal_tag | region | subregion | system_base | system_variant | management_months | system_climate | system_subclimate | climate_zone | climate_moisture | b_0 | allocation |
|:---|:---|:---|:---|:---|---:|:---|:---|:---|:---|:---|---:|
| `mature_dairy_cattle` | `spain` | `north` | `anaerobic_lagoon` | `uncovered` | — | `cool` | `temperate` | `zone_moist` | `wet` | `dairy_cattle_high_productivity` | 0.0537 |
| `mature_dairy_cattle` | `spain` | `north` | `liquid_slurry` | `with_natural_crust_cover` | 3 | `cool` | `temperate` | `zone_moist` | `wet` | `dairy_cattle_high_productivity` | 0.3432 |
| `mature_dairy_cattle` | `spain` | `north` | `solid_storage` | — | — | `cool` | — | — | `default` | `dairy_cattle_high_productivity` | 0.3551 |
| `mature_dairy_cattle` | `spain` | `south` | `solid_storage` | — | — | `warm` | — | — | `default` | `dairy_cattle_high_productivity` | 0.3551 |
