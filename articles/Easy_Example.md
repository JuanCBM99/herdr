...
This guide will walk you through a **Basic Assessment** for **Mature
Dairy Cattle in Spain (2015)**. We will use a single regional identifier
to link your census data to nutritional requirements and environmental
impact.
...
farm. For this basic example, we focus on a national level.
...
The diet must be fulfilled manually based on nutritional reports (e.g.,
Informe Zootécnico 2015).
