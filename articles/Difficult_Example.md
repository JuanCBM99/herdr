...
|:---|:---|:---|:---|:---|:---|:---|:---|---:|---:|:---|:---|:---|
| `mature_dairy_cattle` | `spain` | `north` | `lactation_phase` | `diet_dairy_mature` | `cattle_buffalo [lactating cows]` | `stall` | `females` | 8,295 | 3.73 | `cattle and buffalo` | `cattle` | `dairy` |
| `mature_dairy_cattle` | `spain` | `north` | `dry_phase` | `diet_dairy_mature` | `cattle/buffalo` | `stall` | `females` | 0 | 0 | `cattle and buffalo` | `cattle` | `dairy` |
| `mature_dairy_cattle` | `spain` | `south` | `lactation_phase` | `diet_dairy_mature` | `cattle_buffalo [lactating cows]` | `stall` | `females` | 9,044 | 3.73 | `cattle and buffalo` | `cattle` | `dairy` |
| `mature_dairy_cattle` | `spain` | `south` | `dry_phase` | `diet_dairy_mature` | `cattle/buffalo` | `stall` | `females` | 0 | 0 | `cattle and buffalo` | `cattle` | `dairy` |
