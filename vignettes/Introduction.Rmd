...
For **swine** and **poultry**, metabolizable energy requirements are calculated using the equations published by **FEDNA** and adopted by the **Spanish Ministry of Agriculture, Fisheries and Food (MAPA)** for national nitrogen balance and emission inventories.
