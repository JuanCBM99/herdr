...
This guide explains the workflow for using the `herdr` model, from exploring the default reference datasets to introducing and analysing your own Tier 2 custom scenarios.
