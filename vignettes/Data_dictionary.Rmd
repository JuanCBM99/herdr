...
**herdr** operates on a data-driven approach. While the calculations are universal (IPCC Tier 2), the package comes pre-loaded with **default datasets representing Spanish national averages** for livestock performance, diets, and emission factors.
