...
### A. Check Ingredients
Open `feed_characteristics.csv` and `crop_yields.csv` to see the list of available feed items. If you wish, you can add as many new ingredients as you want, always fulfilling all columns.
