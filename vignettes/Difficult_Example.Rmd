...
### 📂 Folder Structure
* **User Files (Update these):** `livestock_census.csv`, `diet_profiles.csv`, `diet_ingredients.csv`, `ruminant_definitions.csv`, `livestock_weights.csv`, `manure_management.csv`.
