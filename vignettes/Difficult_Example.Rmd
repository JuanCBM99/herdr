...
Ingredients must be assigned precisely to their `subregion` and `class_flex`. Here's the South/lactation profile:
...
This is the most technical file — it determines energy requirements under IPCC Tier 2. Notice how `milk_yield` and `cfi` change between phases.
