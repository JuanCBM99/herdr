---
title: "Dairy Cattle Spain: North/South in different Life Satages"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Dairy Cattle Spain: North/South in different Life Satages}
...
This is the most technical file. It determines the energy requirements (IPCC Tier 2). Note the difference in `milk_yield` and `cfi`.
